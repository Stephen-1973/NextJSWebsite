...
function DraggableText() {
  ...
  return (
    ...
    <motion.div drag style={{ position: 'absolute' }}>
        <Text display={['none','none','inline-block']} fontSize='4rem' fontWeight='regular' textTransform='uppercase' color={bgDraggableText} bg={bgDraggableText}>My WorkSpace</Text>
      </motion.div>
